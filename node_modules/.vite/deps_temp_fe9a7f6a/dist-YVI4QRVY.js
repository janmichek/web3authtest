...
import {
  ...
  toSmartAccount
} from "./chunk-IKNOYJTI.js";
import "./chunk-QXIEA3RY.js";
import {
  generateMnemonic,
  mnemonicToSeedSync,
  validateMnemonic,
...
import {
  HDKey
} from "./chunk-RX6PUPZE.js";
import "./chunk-EEADHRRE.js";
import {
  import_index
} from "./chunk-RJHKLZND.js";
...
import "./chunk-IPRR7LX7.js";
import "./chunk-SLZ3PMUQ.js";
import "./chunk-26A2H3EG.js";
import "./chunk-HVQJ3LFG.js";
import {
  decodeFunctionData,
  encodeFunctionData,
  isAddressEqual
...
var initCCA = () => {
  if (typeof window !== "undefined") {
    ...
    if (window.ClientAnalytics) {
      const { init: init2, identify, PlatformName } = window.ClientAnalytics;
      init2({
        isProd: true,
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/version.js
var version = "1.1.1";

// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/errors.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/regex.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/formatAbiParameter.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/formatAbiParameters.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/formatAbiItem.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/formatAbi.js
function formatAbi(abi2) {
  const signatures = [];
  const length = abi2.length;
  for (let i2 = 0; i2 < length; i2++) {
    const abiItem = abi2[i2];
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/runtime/signatures.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/errors/abiItem.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/errors/abiParameter.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/errors/signature.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/errors/struct.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/errors/splitParameters.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/runtime/cache.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/runtime/utils.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/runtime/structs.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/parseAbi.js
function parseAbi(signatures) {
  ...
  for (let i2 = 0; i2 < length; i2++) {
    ...
    if (isStructSignature(signature))
      continue;
    abi2.push(parseSignature2(signature, structs));
  }
  return abi2;
}

// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/parseAbiItem.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/abitype/dist/esm/human-readable/parseAbiParameters.js
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/utils.js
var _0n2 = BigInt(0);
var _1n2 = BigInt(1);
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/abstract/utils.js
...
function decodeNumber(cursor, param) {
  ...
  const value = cursor.readBytes(32);
  return [
    size5 > 48 ? toBigInt2(value, { signed: signed2 }) : toNumber2(value, { signed: signed2 }),
    32
  ];
}
...
function encodeNumber(value, { signed: signed2, size: size5 }) {
  if (typeof size5 === "number") {
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/hashes/esm/hmac.js
var HMAC = class extends Hash {
  constructor(hash8, _key) {
    ...
    pad4.set(key.length > blockLen ? hash8.create().update(key).digest() : key);
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/abstract/modular.js
var _0n3 = BigInt(0);
var _1n3 = BigInt(1);
var _2n2 = BigInt(2);
var _3n = BigInt(3);
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/abstract/curve.js
var _0n4 = BigInt(0);
var _1n4 = BigInt(1);
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/abstract/weierstrass.js
...
function ecdsa(Point, hash8, ecdsaOpts = {}) {
  ...
  const hmac2 = ecdsaOpts.hmac || ((key, ...msgs) => hmac(hash8, key, concatBytes(...msgs)));
  ...
  function validateSigLength(bytes, format9) {
    ...
    const sizer = format9 === "compact" ? size5 : format9 === "recovered" ? size5 + 1 : void 0;
  ...
  class Signature {
    ...
    static fromHex(hex, format9) {
      return this.fromBytes(hexToBytes2(hex), format9);
    }
  ...
  function validateMsgAndHash(message, prehash) {
    ...
    return prehash ? _abytes2(hash8(message), void 0, "prehashed message") : message;
  }
  ...
  function sign7(message, secretKey, opts = {}) {
    ...
    const drbg = createHmacDrbg(hash8.outputLen, Fn.BYTES, hmac2);
...
function weierstrass(c) {
  const { CURVE, curveOpts, hash: hash8, ecdsaOpts } = _ecdsa_legacy_opts_to_new(c);
  const Point = weierstrassN(CURVE, curveOpts);
  const signs = ecdsa(Point, hash8, ecdsaOpts);
  return _ecdsa_new_output_to_legacy(c, signs);
}

// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/_shortw_utils.js
function createCurve(curveDef, defHash) {
  const create4 = (hash8) => weierstrass({ ...curveDef, hash: hash8 });
  return { ...create4(defHash), create: create4 };
}

// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/abstract/hash-to-curve.js
...
function hash_to_field(msg, count, options) {
  ...
  const { p, k, m, hash: hash8, expand, DST } = options;
  ...
  if (expand === "xmd") {
    ...
    prb = expand_message_xof(msg, DST, len_in_bytes, k, hash8);
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/secp256k1.js
var secp256k1_CURVE = {
...
var InvalidVersionedHashVersionError = class extends BaseError3 {
  constructor({ hash: hash8, version: version3 }) {
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/abstract/bls.js
var _0n7 = BigInt(0);
var _1n7 = BigInt(1);
var _2n5 = BigInt(2);
var _3n3 = BigInt(3);
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/abstract/tower.js
var _0n8 = BigInt(0);
var _1n8 = BigInt(1);
var _2n6 = BigInt(2);
var _3n4 = BigInt(3);
...
function psiFrobenius(Fp3, Fp22, base3) {
  ...
  const PSI_Y = Fp22.pow(base3, (Fp3.ORDER - _1n8) / _2n6);
  function psi(x, y2) {
    const x2 = Fp22.mul(Fp22.frobeniusMap(x, 1), PSI_X);
    const y22 = Fp22.mul(Fp22.frobeniusMap(y2, 1), PSI_Y);
    return [x2, y22];
  }
  const PSI2_X = Fp22.pow(base3, (Fp3.ORDER ** _2n6 - _1n8) / _3n4);
  const PSI2_Y = Fp22.pow(base3, (Fp3.ORDER ** _2n6 - _1n8) / _2n6);
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/bls12-381.js
var _0n9 = BigInt(0);
var _1n9 = BigInt(1);
var _2n7 = BigInt(2);
var _3n5 = BigInt(3);
...
function pointG2FromBytes(bytes) {
  ...
  const slc = (b2, from29, to3) => bytesToNumberBE(b2.slice(from29, to3));
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@adraffy/ens-normalize/dist/index.mjs
...
function decode_arithmetic(bytes) {
  ...
  const MASK = FULL - 1;
  let register = 0;
  for (let i2 = 0; i2 < N; i2++) register = register << 1 | read_bit();
  let symbols = [];
  let low = 0;
  let range = FULL;
  while (true) {
...
function unsafe_atob(s) {
  let lookup = [];
  [..."ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"].forEach((c, i2) => lookup[c.charCodeAt(0)] = i2);
  let n = s.length;
  let ret = new Uint8Array(6 * n >> 3);
  for (let i2 = 0, pos = 0, width = 0, carry = 0; i2 < n; i2++) {
...
function read_deltas(n, next) {
  let v = Array(n);
  for (let i2 = 0, x = 0; i2 < n; i2++) v[i2] = x += signed(next());
  return v;
}
...
function read_linear_table(w, next) {
  ...
  return m.flatMap((v, i2) => {
    let [x, ...ys] = v;
    return Array(vN[i2]).fill().map((_2, j) => {
      let j_dy = j * dy;
...
function read_trie(next) {
  ...
  function decode5(Q) {
    ...
    let B2 = read_array_while(() => {
      ...
      if (cps.length) return decode5(cps);
    });
    return { S, B: B2, Q };
  }
  function expand({ S, B: B2 }, cps, saved) {
...
function compare_arrays(a, b2) {
  let n = a.length;
  let c = n - b2.length;
  for (let i2 = 0; c == 0 && i2 < n; i2++) c = a[i2] - b2[i2];
  return c;
}
...
function init$1() {
  ...
  SHIFTED_RANK = new Map(read_sorted_arrays(r2).flatMap((v, i2) => v.map((x) => [x, i2 + 1 << 24])));
...
function init() {
  ...
  const read_chunked = () => {
    ...
    read_sorted_array().forEach((i2) => set_add_many(set2, chunks[i2]));
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/nist.js
var p256_CURVE = {
...
// node_modules/@base-org/account/node_modules/ox/node_modules/@noble/curves/esm/p256.js
var p2562 = p256;
var secp256r1 = p256;
...
function assert9(envelope) {
  ...
  if (blobVersionedHashes) {
    ...
    for (const hash8 of blobVersionedHashes) {
      ...
      const version3 = toNumber(slice2(hash8, 0, 1));
      if (size5 !== 32)
...
function verify4(options) {
  const { challenge: challenge2, hash: hash8 = true, metadata, publicKey, signature } = options;
...
@noble/curves/esm/p256.js:
  (*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) *)
*/
//# sourceMappingURL=dist-YVI4QRVY.js.map
