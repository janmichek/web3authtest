...
var ICONS = {
  add: async () => (await import("./add-GGGDXWFE.js")).addSvg,
  allWallets: async () => (await import("./all-wallets-BA5YL4KX.js")).allWalletsSvg,
  arrowBottomCircle: async () => (await import("./arrow-bottom-circle-APSAVYE6.js")).arrowBottomCircleSvg,
  appStore: async () => (await import("./app-store-5CD7N5DY.js")).appStoreSvg,
  apple: async () => (await import("./apple-AESJ52XI.js")).appleSvg,
  arrowBottom: async () => (await import("./arrow-bottom-SFG4PMUG.js")).arrowBottomSvg,
  arrowLeft: async () => (await import("./arrow-left-BAIO6GPK.js")).arrowLeftSvg,
  arrowRight: async () => (await import("./arrow-right-TQS2VHBS.js")).arrowRightSvg,
  arrowTop: async () => (await import("./arrow-top-HTHJU3CV.js")).arrowTopSvg,
  bank: async () => (await import("./bank-7TD3DZ5P.js")).bankSvg,
  browser: async () => (await import("./browser-3K73M5RJ.js")).browserSvg,
  card: async () => (await import("./card-QIWQO7EE.js")).cardSvg,
  checkmark: async () => (await import("./checkmark-C3BMHY6W.js")).checkmarkSvg,
  checkmarkBold: async () => (await import("./checkmark-bold-7AYNJXWU.js")).checkmarkBoldSvg,
  chevronBottom: async () => (await import("./chevron-bottom-T2F7CKXV.js")).chevronBottomSvg,
  chevronLeft: async () => (await import("./chevron-left-B6YK24V7.js")).chevronLeftSvg,
  chevronRight: async () => (await import("./chevron-right-7QAICHLO.js")).chevronRightSvg,
  chevronTop: async () => (await import("./chevron-top-NLUC7DRV.js")).chevronTopSvg,
  chromeStore: async () => (await import("./chrome-store-WZO4DAEB.js")).chromeStoreSvg,
  clock: async () => (await import("./clock-DXDTYSMC.js")).clockSvg,
  close: async () => (await import("./close-6SANCNVY.js")).closeSvg,
  compass: async () => (await import("./compass-F3MEIEDS.js")).compassSvg,
  coinPlaceholder: async () => (await import("./coinPlaceholder-NCFVQV2Y.js")).coinPlaceholderSvg,
  copy: async () => (await import("./copy-KXRGZO3T.js")).copySvg,
  cursor: async () => (await import("./cursor-UOJM3FY2.js")).cursorSvg,
  cursorTransparent: async () => (await import("./cursor-transparent-PTGE633W.js")).cursorTransparentSvg,
  desktop: async () => (await import("./desktop-B6NYQ54R.js")).desktopSvg,
  disconnect: async () => (await import("./disconnect-E23TPT2Q.js")).disconnectSvg,
  discord: async () => (await import("./discord-P2ZOWQW5.js")).discordSvg,
  etherscan: async () => (await import("./etherscan-5XONLM2K.js")).etherscanSvg,
  extension: async () => (await import("./extension-GN2COCS4.js")).extensionSvg,
  externalLink: async () => (await import("./external-link-3QTDLH33.js")).externalLinkSvg,
  facebook: async () => (await import("./facebook-G5U3IL3L.js")).facebookSvg,
  farcaster: async () => (await import("./farcaster-J6JZIGZT.js")).farcasterSvg,
  filters: async () => (await import("./filters-F24HZLKG.js")).filtersSvg,
  github: async () => (await import("./github-LCDB2SIX.js")).githubSvg,
  google: async () => (await import("./google-6HHAIG5W.js")).googleSvg,
  helpCircle: async () => (await import("./help-circle-6RJVO2EU.js")).helpCircleSvg,
  image: async () => (await import("./image-EVHXW7UW.js")).imageSvg,
  id: async () => (await import("./id-AVUTVR25.js")).idSvg,
  infoCircle: async () => (await import("./info-circle-B4KMNQ25.js")).infoCircleSvg,
  lightbulb: async () => (await import("./lightbulb-IX6RRLDY.js")).lightbulbSvg,
  mail: async () => (await import("./mail-QXFGI4QD.js")).mailSvg,
  mobile: async () => (await import("./mobile-6TXTIKCF.js")).mobileSvg,
  more: async () => (await import("./more-RZEQPV3Y.js")).moreSvg,
  networkPlaceholder: async () => (await import("./network-placeholder-Y6QEHLL4.js")).networkPlaceholderSvg,
  nftPlaceholder: async () => (await import("./nftPlaceholder-P4GE76EE.js")).nftPlaceholderSvg,
  off: async () => (await import("./off-KZD6LIKJ.js")).offSvg,
  playStore: async () => (await import("./play-store-4VSYUFCF.js")).playStoreSvg,
  plus: async () => (await import("./plus-62JTDWCC.js")).plusSvg,
  qrCode: async () => (await import("./qr-code-L5IVUF4I.js")).qrCodeIcon,
  recycleHorizontal: async () => (await import("./recycle-horizontal-YQ4RGD25.js")).recycleHorizontalSvg,
  refresh: async () => (await import("./refresh-3SNRECST.js")).refreshSvg,
  search: async () => (await import("./search-GE42DOHI.js")).searchSvg,
  send: async () => (await import("./send-GBKCVXAF.js")).sendSvg,
  swapHorizontal: async () => (await import("./swapHorizontal-G6AXZGD2.js")).swapHorizontalSvg,
  swapHorizontalMedium: async () => (await import("./swapHorizontalMedium-K465J4G2.js")).swapHorizontalMediumSvg,
  swapHorizontalBold: async () => (await import("./swapHorizontalBold-GU3MDNUC.js")).swapHorizontalBoldSvg,
  swapHorizontalRoundedBold: async () => (await import("./swapHorizontalRoundedBold-DQ7HUARP.js")).swapHorizontalRoundedBoldSvg,
  swapVertical: async () => (await import("./swapVertical-XNWN26Z5.js")).swapVerticalSvg,
  telegram: async () => (await import("./telegram-GQTNIZ44.js")).telegramSvg,
  threeDots: async () => (await import("./three-dots-QKYD7TMW.js")).threeDotsSvg,
  twitch: async () => (await import("./twitch-57TXIVZX.js")).twitchSvg,
  twitter: async () => (await import("./x-UJUWKMQ3.js")).xSvg,
  twitterIcon: async () => (await import("./twitterIcon-O6EBQYBU.js")).twitterIconSvg,
  verify: async () => (await import("./verify-32S4MTTW.js")).verifySvg,
  verifyFilled: async () => (await import("./verify-filled-OU2GYSQM.js")).verifyFilledSvg,
  wallet: async () => (await import("./wallet-VG6BM7FJ.js")).walletSvg,
  walletConnect: async () => (await import("./walletconnect-X6CM5ENE.js")).walletConnectSvg,
  walletConnectLightBrown: async () => (await import("./walletconnect-X6CM5ENE.js")).walletConnectLightBrownSvg,
  walletConnectBrown: async () => (await import("./walletconnect-X6CM5ENE.js")).walletConnectBrownSvg,
  walletPlaceholder: async () => (await import("./wallet-placeholder-QC7BN63F.js")).walletPlaceholderSvg,
  warningCircle: async () => (await import("./warning-circle-5CBQVOZI.js")).warningCircleSvg,
  x: async () => (await import("./x-UJUWKMQ3.js")).xSvg,
  info: async () => (await import("./info-X6AEH5WI.js")).infoSvg,
  exclamationTriangle: async () => (await import("./exclamation-triangle-ZEVCEFXW.js")).exclamationTriangleSvg,
  reown: async () => (await import("./reown-logo-GSINBGZA.js")).reownSvg
};
...
lit-html/development/directives/until.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6ZC7GPR3.js.map
