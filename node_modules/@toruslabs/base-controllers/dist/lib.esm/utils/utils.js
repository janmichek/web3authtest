import { fromSigned, bytesToBigInt, toUnsigned, stripHexPrefix, bigIntToHex, addHexPrefix, hashPersonalMessage, bigIntToBytes } from '@ethereumjs/util';
...
const getEnvVariable = variable => {
  var _import$meta, _process$env;
  // Check for Vite/browser environment (import.meta.env)
  if (typeof import.meta !== "undefined" && (_import$meta = import.meta) !== null && _import$meta !== void 0 && (_import$meta = _import$meta.env) !== null && _import$meta !== void 0 && _import$meta[variable]) {
    var _import$meta2;
    return (_import$meta2 = import.meta) === null || _import$meta2 === void 0 || (_import$meta2 = _import$meta2.env) === null || _import$meta2 === void 0 ? void 0 : _import$meta2[variable];
  }
